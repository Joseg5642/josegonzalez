...
if ( !version_compare($wp_version,"3.0",">=")) {
	die ($lbg_audio5_html5_shoutcast_messages['version']);
}
...
function lbg_audio5_html5_shoutcast_load_scripts() {
	...
	if(preg_match('/LBG_AUDIO5_HTML5_SHOUTCAST/i', $page)) {
		...
		wp_register_script('lbg-lastfm_api', plugins_url('audio5_html5/js/lastfm.api.js', __FILE__));
		wp_enqueue_script('lbg-lastfm_api');

		wp_register_script('lbg-lastfm_api_cache', plugins_url('audio5_html5/js/lastfm.api.cache.js', __FILE__));
		wp_enqueue_script('lbg-lastfm_api_cache');

		wp_register_script('lbg-lastfm_api_md5', plugins_url('audio5_html5/js/lastfm.api.md5.js', __FILE__));
		wp_enqueue_script('lbg-lastfm_api_md5');
...
function lbg_audio5_html5_shoutcast_preview_record_callback() {
	...
	$aux_val='<html>
					<head>
						...
						<script src="'.plugins_url('audio5_html5/js/lastfm.api.md5.js', __FILE__).'" type="text/javascript"></script>
						<script src="'.plugins_url('audio5_html5/js/lastfm.api.js', __FILE__).'" type="text/javascript"></script>
						<script src="'.plugins_url('audio5_html5/js/lastfm.api.cache.js', __FILE__).'" type="text/javascript"></script>
						<!-- and new libraries to use lastfm -->
